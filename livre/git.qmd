...
!!! Important de bien structurer son projet pour faciliter la collaboration et la reproductibilité. Voir la section Bien structurer son projet du chapitre [Bonnes pratiques](https://econumuds.github.io/BIO500/bonnes_pratiques.html) dédiée à ce sujet.
...
Les restrictions d'accès au répertoire GitHub et les invitations peuvent être gérées à partir du site web du répertoire. Pour ajouter un collaborateur à votre répertoire GitHub, il faut :
- Aller sur votre répertoire GitHub.
- Cliquer sur "Settings" > "Manage access" > "Invite a collaborator".
- Entrer le nom d'utilisateur de votre partenaire et l'inviter à collaborer.
