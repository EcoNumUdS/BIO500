...
l'insérer dans votre rapport. La procédure est assez simple: il s'agit de préparer son tableau dans R, écrire le tableau LaTeX
...
Je vais ensuite me servir du package R `xtable` pour transformer l'objet `iris`, qui une fois chargé
...
stats_desc_tex <- xtable(stats_desc,format="latex",caption = 'Statistiques descriptives de la longeur du sépale chez Iris sp.}')
# On ajoute une légende avec l'argument caption.
