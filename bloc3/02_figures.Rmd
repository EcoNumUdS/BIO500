...
Les notions sont abordés dans les chapitres [10](https://econumuds.github.io/BIO500/figures.html), [11](https://econumuds.github.io/BIO500/composantes_graphiques.html) et [12](https://econumuds.github.io/BIO500/cartes.html) du livre.
...
## Atelier `Séance 5 - Principes de reproductibilité`

1. Observations sur la scalabilité, robustesse et réutilisabilité
...
1. Le tableau de bord [Santé Québec](https://app.powerbi.com/view?r=eyJrIjoiOGIyZWI4NGQtN2FjZC00OGFjLTgwMWYtZmM3N2M3ZjYyNjU2IiwidCI6IjA2ZTFmZTI4LTVmOGItNDA3NS1iZjZjLWFlMjRiZTFhNzk5MiJ9)
...
Message : La présence des chauve-souris varie selon les espèces et la date.
...
Scripter votre figure sur R à l'aide des [données](./assets/data/phenologie.csv) (Moodle > Bloc 3 > phenologie.csv)
...
Deux types de données spatiales (géographiques) :
...
Gnénérez une carte de la pollution lumineuse pour le mont Bellevue.

Pollution lumineuse (Raster) : Moodle > Bloc 3

Mont Bellevue (Vectoriel) : Moodle > Bloc 3
...
- Compléter votre analyse au moyen de 3 figures
...
<!-- Demander quels sont les outils et pratiques existants pour répondre aux principes FAIR. -->
...
## 1. Quels sont les liens concrets entre les principes FAIR et les étapes d'une étude scientifique ?

<br>
.center[
  <img src="assets/img/flow_bio500.png" width="75%"></img>
]

## 2. Comment appliquer les principes FAIR aux programmes (code) ?