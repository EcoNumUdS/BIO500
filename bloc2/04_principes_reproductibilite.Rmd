...
- Joignez le dépôt github pour votre projet 
- Créez un cahier de laboratoire où sont notées toutes vos étapes
- Documentez votre code et vos données
- Ajoutez des logs pour suivre l'exécution de votre programme
- Testez votre code et sauvez les tests dans votre dépôt
...
<br>
## 10 minutes pour préparer ses arguments
## 2 minutes pour présenter ses arguments
## Discussion

--
   - *Règles de l'université de Sherbrooke*
--
   - Fiabilité et biais
--
   - Automatisation et créativité scientifique
--
   - Accès aux données et reproductibilité
--
   - Éthique et impacts environnementaux
