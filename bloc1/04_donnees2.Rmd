...
- `statut IS NULL` permet d'obtenir seulement les auteurs n'ayant pas de statuts.
]]
...
Dans ta table `auteur`, essayer de trouver les auteurs dont l'institution est `Universite de Sherbrooke`.
...
À l'aide de la base de données `reseau`, dénombrer le nombre d'auteur par article

Quels sont les 10 auteurs les plus prolifiques?
