...
# Les données temporelles
 ...
 Gardez à l'esprit que vos données pourraient être réutilisé à travers le Monde. Les dates ne sont pas représentées de la même manière que l'on soit en Amérique du Nord ou en Europe. **Il est donc important de normaliser la saisie de ce type d'information.**

--- &twocol

# Les données temporelles

Une autre représentation de la date du jour peut-être basée sur le calendrier Julien.
...
## Selon vous, quelle est le choix le plus approprié ?
