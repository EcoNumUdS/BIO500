...
Quelques exemples : 
 ...
 >- La couleur des yeux
 >- La grandeur des chausseurs
 >- Le noms de votre grand-mère
 >- Est-ce que vous courrez en sentier ?
 >- Minutes au kilomètre
 >- Tourne à gauche ou à droite ?
 >- Poutine préférée
 >- Avez-vous déjà vu une grive de Bicknell ?
...
.pull-right[
  .font90[
  >- Pour créer, interroger, gérer et maintenir des bases de données, on utilisera un **[Système de Gestion de Base de Données](https://www.youtube.com/watch?v=rGm6imM-7AI) (souvent appelé SGBD)**.
  >- Mais ces systèmes disposent tous d'un dénominateur commun: le `langage SQL`
  >- SQL - Définition : Seul le Québec Libre 
  ]
]
...
5. Libérer le Québec.
6. Supprimer des données ou des tables (`DROP`, `DELETE`).
7. Soupirer très fort.
8. Mettre à jour des données ou des tables (`UPDATE`, `ALTER`).
9. Supprimer la base de données (`DROP DATABASE`).
...
# Pourquoi McGill pense être la meilleure université

- Parce que Graham Bell a inventé le téléphone
- Parce que Victor Cameron a fait son BSc là !
- Ils ont un musée
- Parce que Victor Cameron a fait son BSc là !
