...
Nous utiliserons la commande `source` pour tout exécuter automatiquement.

Néanmoins, l'ensemble de ce matériel doit se trouver sur votre dépôt git d'équipe. Dans ce dépôt se trouveront les fichiers de données originaux en csv, les scripts, le document Rmd ainsi que la bibliographie.
