...
Alternativement, pour une séquence d'analyse très compliquée, on pourrait vouloir regrouper les étapes pour éviter d'avoir une liste trop longues.  
...
Il arrive que certains scripts génèrent des fichiers temporaires qui ne doivent pas être conservés inutilement. C'est le cas notamment des fichiers du dossier 'meta' qui sont utiles pour le diagnostique mais pas nécessaire d'être poussés sur github. 
