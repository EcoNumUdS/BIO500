...
- L'utilisation d'outils d'IAg (ex. ChatGPT, Copilot, etc.) est permise pour la réalisation des travaux du cours. Cependant, il faut citer ces outils en précisant la nature de l'assistance fournie par l'outil (voir plan de cours pour détails).
