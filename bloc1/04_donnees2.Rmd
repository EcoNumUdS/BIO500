...
1. Retour sur l'évaluation formative #1
2. Retour sur le dernier cours [[Chapitre 4 Bases de données](https://econumuds.github.io/BIO500/bases_de_donnees.html)]
3. Le langage de requête SQL [[Chapitre 5 SQL et RSQLite](https://econumuds.github.io/BIO500/sql.html)]
4. Exercices pratiques [[Chapitre 6 Exercices](https://econumuds.github.io/BIO500/exercices_1.html)]
5. Travail de la semaine
6. Discussion sur les enjeux de reproductibilité en science expérimentale

---

# Évaluation formative #1

Était à remettre hier (9 février)

## Vous avez jusqu'à lundi prochain (16 février) pour compléter l'évaluation des scripts d'assemblage et de nettoyage d'une autre équipe.
...
Vous trouverez une description et des exemples d'utilisation dans le chapitre 5 [*SQL et RSQLite*](https://econumuds.github.io/BIO500/sql.html#jointures-entre-tables)
...
# Travail de la semaine (à débuter cette semaine)
...
- À compléter pour le **17 février**
...
1.     Quel est l'état de la reproductibilité en science ? Est-ce que les chercheurs sondés ont une opinion juste ?
2.     "We want to be discovering new things but not generating too many false leeds." Quel est le lien entre la reproductibilité et l'innovation ?
3.     Quels sont les particularités des domaines scientifiques qui sont les plus touchés par le problème de reproductibilité ?
4.     Avez-vous vécu certains de ces problèmes dans le cadre d'un exercice ou d'un projet scolaire ?

## 7 minutes pour comparer les réponses en équipe

> Pour aller plus loin : des questions supplémentaires sont sur Moodle *Bloc1 > Questions pour discussion - cours #2*

## 7 minutes de partage
